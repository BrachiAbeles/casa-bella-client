...
//   const [value, setValue] = useState(0);
  ...
  return (<>
    ...
    <div style={{ display: "flex", flexDirection: "row", width: "97%", position: "sticky", padding: "1.5%", backgroundColor: "white", top: "0%", direction: "rtl" }}>
      ...
      <Box sx={{ display: "flex", flexDirection: "row", marginRight: "81%", position: "absolute", justifyContent: "space-evenly", width: "15%" }}>
        ...
        <Button style={{ backgroundColor: "black", color: "white", width: "35%", fontSize: "medium", marginRight: "10%", fontWeight:"bolder" }}>אורח</Button>

        {/* <Button onClick={() => {dispatch(userOut(user)); alert('נשמח לראותך שוב')}} style={{ backgroundColor: "black", color: "white", width: "35%", marginRight: "10%" }}>יציאה</Button> */}
        {/* </BottomNavigation> */}
      </Box>
    </div>
  </>
